...
class ShoppingSteps:
    ...
    def react_fetch_product_results_found(self, expected_result) -> bool:
    ...
    def react_quit_shopping(self) -> None:
        self.shopping_steps.quit_shopping()

    @allure.step("Fetch Product title")
    def react_fetch_product_title(self) -> None:
    ...
    def react_verify_product_titles_after_applying_multiple_filters(self) -> None:
    ...
    def react_add_few_items_in_cart(self, how_many, return_items_with_price, free_shipping, same_item) -> List:
    ...
    def react_add_few_items_in_cart_with_shipping_label(self, how_many, return_items_with_price) -> List:
        return self.shopping_steps.add_few_items_in_cart(return_items_with_price=return_items_with_price,
                                                         free_shipping=True, count=how_many, same_item=False)

    @allure.step("Add few items into the cart not having free shipping label")
    def react_add_few_items_in_cart_without_shipping_label(self, how_many, return_items_with_price) -> List:
        return self.shopping_steps.add_few_items_in_cart(return_items_with_price=return_items_with_price,
                                                         free_shipping=False, count=how_many, same_item=False)

    @allure.step("Verify prices of items in the cart page")
    def react_verify_price_of_items_in_cart(self, item_info, expected_result) -> None:
    ...
    def react_verify_total_items_in_cart(self, expected_result) -> None:
    ...
    def react_verify_quantity_of_items_in_cart(self, item_info, quantity) -> None:
